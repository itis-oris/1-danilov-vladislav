...
<link rel="stylesheet" href="${pageContext.request.contextPath}/styles/w4.css">
<html>
<head>
...
<div id = wrapper>
    <div id = "header" align="center">
        ...
        <c:if test="${pravo}">
            <img class="myImage2" src="${pageContext.request.contextPath}/icons/plus-svgrepo-com.svg" onclick="location.href='${pageContext.servletContext.contextPath}/add_employee'">
        </c:if>
